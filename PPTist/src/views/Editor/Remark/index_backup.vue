<template>
  <div class="enhanced-remark">
    ...
    <div class="editor-container" :class="{ 'split-mode': manualSplitEnabled }">
      ...
      <!-- 右侧提示区域 -->
      <div class="editor-sidebar" v-if="manualSplitEnabled">
        <!-- 分割辅助信息 -->
        ...
        <!-- 实时字符长度显示 -->
        <div class="line-stats" v-if="hasNewlines">
...
.line-stats {
  ...
  .stats-header {
    ...
    .title { font-weight: 600; color: #495057; font-size: 12px; }
    .limit-info { font-size: 10px; color: #6c757d; background: #e9ecef; padding: 2px 6px; border-radius: 8px; text-align: center; }
  }
  
  .line-items { max-height: 200px; overflow-y: auto; }
  ...
  .line-item {
    ...
    &.warning { 
      ...
      .char-ratio { color: #dc3545; font-weight: 600; } 
    }
    ...
    .line-number { font-size: 10px; color: #6c757d; font-weight: 500; }
    .char-ratio { font-weight: 600; color: #495057; font-size: 11px; }
    .line-content { 
      color: #495057; 
      font-size: 10px; 
      overflow: hidden; 
    ...
    .warning-text { font-size: 9px; color: #dc3545; font-weight: 500; margin-top: 1px; }
  }
}
